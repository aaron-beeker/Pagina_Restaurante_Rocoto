            ...
            <div class="relative h-full w-80 bg-surface shadow-2xl flex flex-col z-[110] animate-slide-in-left">
                ...
                <!-- Icono de Menú del día -->
                  <a class="mobile-nav-link flex items-center gap-5 p-5 rounded-3xl text-xl font-extrabold text-on-background hover:bg-background active:bg-primary/5 transition-colors" href="#daily-menu">
                      <div class="p-3 rounded-2xl bg-transparent text-primary">
                          <!-- Reemplaza el <svg> por esto -->
                          <img src="data:image/svg+xml;base64," class="h-7 w-7 object-contain" alt="Menú" />
                      </div>
                      Menú del día
                  </a>
                ...
                <!-- Icono de La carta -->        
                  <a class="mobile-nav-link flex items-center gap-5 p-5 rounded-3xl text-xl font-extrabold text-on-background hover:bg-background active:bg-primary/5 transition-colors" href="#menu">
                      <div class="p-3 rounded-2xl bg-transparent text-secondary">
                          <img src="data:image/svg+xml;base64," class="h-7 w-7 object-contain" alt="Carta" />
                      </div>
                      La carta
                  </a>
            ...
            <div class="relative h-full w-80 bg-surface shadow-2xl flex flex-col z-[110] animate-slide-in-right">
                ...
                ${!user ? `
                  <div class="flex flex-col gap-3 w-full">
                      <button id="login-btn-panel" class="flex items-center justify-center gap-3 w-full bg-white text-on-background border border-surface-variant rounded-[2rem] py-4 px-6 shadow-sm hover:bg-background transition-all active:scale-95 font-bold text-sm">
                      ...
                      <!-- NUEVO BOTÓN MOZO -->
                      <button id="mozo-login-btn" class="flex items-center justify-center gap-3 w-full bg-primary text-white rounded-[2rem] py-4 px-6 shadow-lg shadow-primary/20 hover:brightness-110 transition-all active:scale-95 font-bold text-sm">
              ...
              ` : ''}
                  ...
                  ${user?.role === 'admin' ? `
                      ...
                      <button id="admin-fasal-attendance-btn" class="flex items-center gap-5 rounded-[2rem] px-5 py-5 text-base font-bold text-on-surface-variant hover:bg-background hover:text-primary transition-all text-left">
                        <div class="p-3 rounded-2xl bg-green-50 text-green-600">
                          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                        </div>
                        Registrar Asistencia
                      </button>

                      <button id="admin-fasal-manage-attendance-btn" class="flex items-center gap-5 rounded-[2rem] px-5 py-5 text-base font-bold text-on-surface-variant hover:bg-background hover:text-primary transition-all text-left">
                        <div class="p-3 rounded-2xl bg-teal-50 text-teal-600">
                          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                        </div>
                        Gestión de Asistencias
                      </button>

                      <button id="admin-fasal-workers-btn" class="flex items-center gap-5 rounded-[2rem] px-5 py-5 text-base font-bold text-on-surface-variant hover:bg-background hover:text-primary transition-all text-left">
                        <div class="p-3 rounded-2xl bg-blue-50 text-blue-600">
                          <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        </div>
                        Gestionar Trabajadores
                      </button>

                      <button id="admin-fasal-companies-btn" class="flex items-center gap-5 rounded-[2rem] px-5 py-5 text-base font-bold text-on-surface-variant hover:bg-background hover:text-primary transition-all text-left">

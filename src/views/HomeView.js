                    ...
                    <div class="space-y-6">
                      ...
                      <div class="flex flex-col gap-1">
                        ...
                        <button id="admin-daily-menu-btn" class="admin-panel-btn-new group/btn" data-color="emerald">
                            <div class="icon-box bg-primary/5 text-primary group-hover/btn:bg-primary group-hover/btn:text-white"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"/></svg></div>
                            <span class="text-sm font-bold uppercase tracking-tighter">Menú del Día</span>
                        </button>
                        <button id="admin-manage-carta-btn" class="admin-panel-btn-new group/btn" data-color="emerald">
                            <div class="icon-box bg-primary/5 text-primary group-hover/btn:bg-primary group-hover/btn:text-white"><svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg></div>
                            <span class="text-sm font-bold uppercase tracking-tighter">Gestionar Carta</span>
                        </button>
                        <button id="admin-hero-promo-btn" class="admin-panel-btn-new group/btn" data-color="emerald">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Banner Principal</span>
                        </button>
                      </div>
                      ...
                      <div class="flex flex-col gap-1">
                        ...
                        <button id="admin-fasal-attendance-btn" class="admin-panel-btn-new group/btn" data-color="blue">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Registrar Asistencia</span>
                        </button>
                        <button id="admin-fasal-manage-attendance-btn" class="admin-panel-btn-new group/btn" data-color="blue">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Reportes de Pensión</span>
                        </button>
                        <button id="admin-fasal-workers-btn" class="admin-panel-btn-new group/btn" data-color="blue">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Lista de Personal</span>
                        </button>
                        <button id="admin-fasal-companies-btn" class="admin-panel-btn-new group/btn" data-color="blue">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Empresas Aliadas</span>
                        </button>
                      </div>
                      ...
                      <div class="flex flex-col gap-1">
                        ...
                        <button id="admin-manage-users-btn" class="admin-panel-btn-new group/btn" data-color="purple">
                            ...
                            <span class="text-sm font-bold uppercase tracking-tighter">Control de Accesos</span>
                        </button>
                      </div>
                    </div>
                  ` : ''}

...
export class ManageUsersView {
                    ...
                    <div class="space-y-24">
                        ...
                        <section class="space-y-12">
                            <div class="flex items-center gap-4">
                                <span class="text-primary font-black font-display italic text-2xl sm:text-3xl">01.</span>
                                <h3 class="text-xs sm:text-sm font-black uppercase tracking-[0.5em]">Seguridad de Usuarios</h3>
                            </div>
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                                ...
                                <div class="lg:col-span-7 order-2 lg:order-1 space-y-6">
                                    <div class="flex items-center gap-4 ml-2 mb-6">
                                        ...
                                        <span class="text-[10px] font-black uppercase tracking-[0.3em] text-stone-900">Personal en el Sistema (${users.length})</span>
                                    </div>
                                    
                                    <div id="users-list" class="flex flex-col gap-4">
                                        ${users.length === 0 
                                            ? html`<div class="py-24 text-center border-2 border-dashed border-stone-100 rounded-[3rem] text-stone-300 uppercase tracking-[0.4em] text-[10px] font-bold italic bg-stone-50/30">Sin accesos configurados</div>` 
    ...
    _prepareEdit(u) {
        ...
        const radio = this.rootElement.querySelector(`input[name="user-role"][value="${u.role || 'client'}"]`);
    ...
    async _handleDelete(email, onDelete) {
        if (await dialog.confirm("Quitar Permisos", `¿Está seguro de eliminar el acceso para ${email}?`)) {
            onDelete(email);
        }
    }
            ...
            <header class="flex flex-col sm:flex-row sm:items-end justify-between gap-8 mb-16 sm:mb-20 pb-8 border-b border-stone-200">
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="flex flex-col gap-2">
                        <span class="text-[8px] sm:text-[9px] uppercase tracking-[0.3em] sm:tracking-[0.4em] text-stone-400 font-bold">Seguridad y Privacidad</span>
                        <h2 class="text-3xl sm:text-6xl font-display italic text-stone-950 leading-none">
                            Gestión de <span class="text-primary font-black not-italic underline decoration-stone-200 underline-offset-8">Usuarios</span>
                        </h2>
                    </div>
                </div>
            </header>

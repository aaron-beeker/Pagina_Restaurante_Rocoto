...
export const button = {
  ...
  outlineDark: "border-2 border-surface-variant text-on-surface-variant hover:bg-background px-6 py-3 sm:px-8 sm:py-4",
  ghost: "text-on-surface-variant hover:text-primary hover:bg-background px-3 py-2 sm:px-4 sm:py-2.5",
...
export const form = {
  ...
  input: "w-full rounded-xl border-surface-variant bg-background text-sm shadow-sm transition-all focus:border-primary focus:ring-primary/10",

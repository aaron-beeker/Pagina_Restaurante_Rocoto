...
export const restaurantInfo = new RestaurantInfo({
  ...
  mapsEmbedUrl:
    "https://www.google.com/maps?q=Restaurante%20Rocoto%2C%20C.%20Peru%20379%2C%20San%20Ramon%2C%20Peru&output=embed",
});
...
export const menuSeed = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1626202340534-f1639844439c?q=80&w=1200&auto=format&fit=crop",
  },
];

export const recetarioPlatos = [];
export const opcionesEntradas = [
  "Crema de alverja",
  "Causa rellena",
  "Papa a la huancaína",
  "Sopa del día",
